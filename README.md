...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,371 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,069 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05: Slice GeoJSON into vector tiles on the fly in the browser
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 807 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-11: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 84 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,236 | 🐛 323 | 🌐 Java | 📅 2026-09-13)
