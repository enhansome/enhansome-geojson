...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,481 | 🐛 287 | 🌐 TypeScript | 📅 2026-09-07: collection of functions for spatial operations and analysi
...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,369 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03: A fast GeoJSON clustering library for browsers and Node.
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 807 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-11: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 84 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,236 | 🐛 344 | 🌐 Java | 📅 2026-09-12)
