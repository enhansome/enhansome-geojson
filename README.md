...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,473 | 🐛 285 | 🌐 TypeScript | 📅 2026-09-07: collection of functions for spatial operations and analysi
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,099 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 802 | 🐛 38 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 85 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,235 | 🐛 349 | 🌐 Java | 📅 2026-09-01)
