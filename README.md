# awesome geojson with stars

GeoJSON utilities that will make your life easier.

### operations

* [turf](https://github.com/Turfjs/turf) ⭐ 10,467 | 🐛 285 | 🌐 TypeScript | 📅 2026-08-31: collection of functions for spatial operations and analysi
...
* [geojson-rewind](https://github.com/mapbox/geojson-rewind) ⭐ 133 | 🐛 5 | 🌐 JavaScript | 📅 2026-06-29: enforce ring winding order
...
* [geojson-polygon-labels](https://github.com/andrewharvey/geojson-polygon-labels) ⭐ 89 | 🐛 5 | 🌐 JavaScript | 📅 2024-08-26: generate point labels from GeoJSON polygons
* [winnow](https://github.com/dmfenton/winnow) ⭐ 88 | 🐛 15 | 🌐 JavaScript | 📅 2023-08-13: run sql queries against geojson with javascript
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 83 | 🐛 32 | 🌐 Dart | 📅 2026-07-10: a turf.js port for Dart and Flutter
...
* [geojson-normalize](https://github.com/mapbox/geojson-normalize) ⭐ 34 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-13: normalize any geojson object into a geojson featurecollection
* [geojson-coords](https://github.com/mapbox/geojson-coords) ⭐ 33 | 🐛 2 | 🌐 JavaScript | 📅 2026-06-24: Extract coordinates from GeoJSON
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,097 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
* [geojson-indoor-tools](https://github.com/armanjr/geojson-indoor-tools) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2023-01-24: Python tools for editing indoor GeoJSON features: adding room heights, building walls and creating doors
...
* [geojson-id-streaming](https://github.com/andrewharvey/geojson-id-streaming) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2017-11-30: Add a unique id to each Feature
...
* [geojson2image](https://github.com/brycejohnston/geojson2image) ⭐ 15 | 🐛 0 | 🌐 Ruby | 📅 2018-09-25: library for generating images from GeoJSON
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 285 | 🐛 10 | 🌐 Python | 📅 2026-09-04: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
* [geojsonhint](https://github.com/mapbox/geojsonhint) ⚠️ Archived: find errors in your geojson files
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 110 | 🐛 4 | 🌐 Python | 📅 2026-09-03: Fix GeoJSON polygons that cross the antimeridian (Python package)
...
* [eudr-geojson-fixtures](https://github.com/vancebw/eudr-geojson-fixtures) ⭐ 0 | 🐛 0 | 📅 2026-08-16: test fixtures for EUDR geolocation data: valid plot examples plus common failure modes like axis swaps and self-intersecting rings
...
* [geojsonio-cli](https://github.com/mapbox/geojsonio-cli) ⚠️ Archived: send geojson features to geojson.io from your command line
* [featureserver](https://github.com/featureserver/featureserver) ⭐ 102 | 🐛 27 | 🌐 JavaScript | 📅 2023-07-13: An open source Esri-Style Feature Server
* [geojsonio-extension](https://github.com/mapbox/geojsonio-extension) ⚠️ Archived: chrome extension for editing github files in geojson.io
...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,356 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,045 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03: Slice GeoJSON into vector tiles on the fly in the browser
...
* [geojson2rtree](https://github.com/maxogden/geojson2rtree) ⭐ 9 | 🐛 2 | 🌐 JavaScript | 📅 2014-04-10: generate a static rtree (using terraformer) from a set of geojson features
* **CSV**
...
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,247 | 🐛 58 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
...
* **OpenStreetMap**
  * [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 750 | 🐛 59 | 🌐 JavaScript | 📅 2026-04-23: convert OpenStreetMap data to GeoJSON
  * [query-overpass](https://github.com/perliedman/query-overpass) ⭐ 158 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-28 CLI to make Overpass query and transform result to GeoJSON. Based on [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 750 | 🐛 59 | 🌐 JavaScript | 📅 2026-04-23
  * [osm2geojson](https://github.com/aspectumapp/osm2geojson) ⭐ 113 | 🐛 3 | 🌐 Python | 📅 2026-09-03: (Python) converts OSM XML and Overpass XML/JSON to GeoJSON
  * [osm-and-geojson](https://github.com/aaronlidman/osm-and-geojson) ⭐ 91 | 🐛 6 | 🌐 JavaScript | 📅 2016-07-14: convert GeoJSON to OSM XML and OSM XML to GeoJSON
  * [minjur](https://github.com/mapbox/minjur) ⚠️ Archived: converts OpenStreetMap data to GeoJSON faster than anything else
  * [geojsontoosm](https://github.com/tyrasd/geojsontoosm) ⭐ 26 | 🐛 6 | 🌐 JavaScript | 📅 2024-04-18: convert GeoJSON to OSM XML
  * [osm2geojson](https://github.com/rclark/osm2geojson) ⭐ 12 | 🐛 1 | 🌐 JavaScript | 📅 2017-06-28: converts OSM XML to GeoJSON
  * [geojson2osm](https://github.com/Rub21/geojson2osm) ⭐ 6 | 🐛 3 | 🌐 JavaScript | 📅 2019-11-11: convert GeoJSON to OSM XML
  * [geojson2osm-es6](https://github.com/DenisCarriere/geojson2osm-es6/) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2016-11-21: convert GeoJSON to OSM XML

### data

* [geo-maps](https://github.com/simonepri/geo-maps) ⭐ 1,350 | 🐛 16 | 🌐 JavaScript | 📅 2019-05-29: High Quality GeoJSON maps programmatically generated.
* [world-atlas](https://github.com/topojson/world-atlas) ⚠️ Archived: customizable simplified versions of natural earth data
* [us-atlas](https://github.com/topojson/us-atlas) ⭐ 926 | 🐛 9 | 🌐 Shell | 📅 2024-01-02: geojson & topojson for United States features
* [france-geojson](https://github.com/gregoiredavid/france-geojson) ⭐ 831 | 🐛 17 | 📅 2022-12-02: Outlines of regions, departments, arrondissements, cantons and communes of France (mainland and overseas departments) in GeoJSON format
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 797 | 🐛 37 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [99boundaries](https://github.com/TimMcCauley/nintynine-boundaries) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-01-03: Generate any maritime & land boundary in GeoJSON and other file formats or [download directly from the web](https://99boundaries.com)
* [tgn-geojson](https://github.com/straup/tgn-geojson) ⭐ 15 | 🐛 0 | 📅 2015-10-25: The Getty Thesaurus of Geographic Names (TGN) As GeoJSON.
* [whereonearth-airport](https://github.com/straup/whereonearth-airport) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2013-06-14: outlines of every airport
* [whereonearth-building](https://github.com/straup/whereonearth-building/) ⭐ 11 | 🐛 0 | 📅 2011-11-01: building outlines
* [strava-to-geojsonio](https://github.com/taketime/strava-to-geojsonio) ⭐ 7 | 🐛 1 | 🌐 JavaScript | 📅 2022-12-05: export runs & rides from Strava to GeoJSON
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 85 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,234 | 🐛 345 | 🌐 Java | 📅 2026-09-01)
