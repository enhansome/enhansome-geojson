...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,432 | 🐛 285 | 🌐 TypeScript | 📅 2026-08-17: collection of functions for spatial operations and analysi
...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,351 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-10: A fast GeoJSON clustering library for browsers and Node.
...
* [geo-maps](https://github.com/simonepri/geo-maps) ⭐ 1,348 | 🐛 16 | 🌐 JavaScript | 📅 2019-05-29: High Quality GeoJSON maps programmatically generated.
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 781 | 🐛 37 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 84 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,224 | 🐛 340 | 🌐 Java | 📅 2026-08-14)
