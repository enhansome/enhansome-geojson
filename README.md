...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,459 | 🐛 283 | 🌐 TypeScript | 📅 2026-08-18: collection of functions for spatial operations and analysi
...
* [geojson-shave](https://github.com/ben-n93/geojson-shave) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2025-05-04: a Python command-line tool for reducing the size of GeoJSON files.
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 788 | 🐛 37 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 85 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,224 | 🐛 343 | 🌐 Java | 📅 2026-08-25)
