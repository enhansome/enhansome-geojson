...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,431 | 🐛 286 | 🌐 TypeScript | 📅 2026-08-12: collection of functions for spatial operations and analysi
...
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 110 | 🐛 5 | 🌐 Python | 📅 2026-08-10: Fix GeoJSON polygons that cross the antimeridian (Python package)
* [gjf](https://github.com/yazeed44/gjf) ⭐ 104 | 🐛 2 | 🌐 Python | 📅 2021-06-22: A tool to fix invalid GeoJSON objects
* [check-geojson](https://github.com/placemark/check-geojson) ⭐ 85 | 🐛 6 | 🌐 TypeScript | 📅 2025-02-18: alternative to geojsonhint
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,901 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,347 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-10: A fast GeoJSON clustering library for browsers and Node.
...
* [wellknown](https://github.com/mapbox/wellknown) ⭐ 280 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-29: convert WKT to GeoJSON
...
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,247 | 🐛 57 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
...
* [geo-maps](https://github.com/simonepri/geo-maps) ⭐ 1,347 | 🐛 16 | 🌐 JavaScript | 📅 2019-05-29: High Quality GeoJSON maps programmatically generated.
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 778 | 🐛 37 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 84 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,223 | 🐛 344 | 🌐 Java | 📅 2026-08-14)
...
* [geojson-invalid-geometry](https://github.com/chrieke/geojson-invalid-geometry) ⭐ 48 | 🐛 0 | 🌐 Python | 📅 2026-08-02: List of GeoJSON invalid geometry issues with example files.
