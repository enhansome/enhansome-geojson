...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,488 | 🐛 288 | 🌐 TypeScript | 📅 2026-09-07: collection of functions for spatial operations and analysi
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,103 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [Vector Tile Lab](https://github.com/spider-hand/vector-tile-lab) ⭐ 42 | 🐛 0 | 🌐 Vue | 📅 2026-03-03: An interactive sandbox to tune vector tiles
...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,375 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,077 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05: Slice GeoJSON into vector tiles on the fly in the browser
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 813 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-15: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 84 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,235 | 🐛 323 | 🌐 Java | 📅 2026-09-16)
