...
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 83 | 🐛 32 | 🌐 Dart | 📅 2026-09-24: a turf.js port for Dart and Flutter
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 287 | 🐛 5 | 🌐 Python | 📅 2026-09-21: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 823 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-15: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 84 | 🌐 Java | 📅 2026-07-31: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,235 | 🐛 326 | 🌐 Java | 📅 2026-09-16)
